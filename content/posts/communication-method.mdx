...
category: 개발
image: /thumbnail/communication-method.png
---

# 프론트엔드에서 서버와 통신하는 모든 방식 정리

HTTP · Polling · Long Polling · WebSocket · SSE · GraphQL까지
...
이 구조는 프론트엔드 개발자가 실시간 통신을 이해하고 비교하는 데 좋은 기반이 될 것입니다.
